...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { cellphone: @manager.cellphone, lastname: @manager.lastname, name: @manager.name } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { cellphone: @manager.cellphone, lastname: @manager.lastname, name: @manager.name } }
